...
% chktex-file 1
% chktex-file 44
\usepackage[left=1.15in,right=1in,top=1in,bottom=1in]{geometry}
...
\newif\iffrontborderpage
\frontborderpagefalse

% Match the updated sample report's top/bottom double page border.
\AddToShipoutPictureBG{%
    \iffrontborderpage
    \AtPageLowerLeft{%
        % Top Border
        \linethickness{0.5pt}%
        \put(0,\LenToUnit{\dimexpr\paperheight-24pt\relax}){\line(1,0){\LenToUnit{\paperwidth}}}%
        \linethickness{1.5pt}%
        \put(0,\LenToUnit{\dimexpr\paperheight-28pt\relax}){\line(1,0){\LenToUnit{\paperwidth}}}%
        % Bottom Border
        \linethickness{1.5pt}%
        \put(0,\LenToUnit{28pt}){\line(1,0){\LenToUnit{\paperwidth}}}%
        \linethickness{0.5pt}%
        \put(0,\LenToUnit{24pt}){\line(1,0){\LenToUnit{\paperwidth}}}%
    }%
    \fi
}
...
% Match reference report chapter and heading format.
\titlespacing*{\chapter}{0pt}{-30pt}{22pt}
\titleformat{\chapter}[display]
    {\normalfont\fontsize{14}{18}\bfseries\centering}
    {\MakeUppercase{\chaptername}\ \thechapter}
    {8pt}
    {\normalfont\fontsize{16}{20}\bfseries\centering\MakeUppercase}
\titleformat{\section}
...
\begin{titlepage}
    ...
    \vspace{0.6cm}
    \includegraphics[height=0.12\textwidth]{images/AMC-LOGO.png}
...
Certified that the Project work entitled \textbf{``ACIS-X: AUTOMATED CREDIT CONTROL SYSTEM''} carried out by bonafide students \textbf{NITIN BHARADWAJ M V S (1AM23CS125)}, \textbf{NIKHIL NAGENDRA (1AM23CS120)}, \textbf{JOHAN K GEORGE (1AM23CS075)}, and \textbf{PRASANNA ACHARYA (1AM23CS149)} of AMC Engineering College, in partial fulfillment for the award of Bachelor of Engineering in Computer Science \& Engineering of Visvesvaraya Technological University, Belgaum during the year 2025-2026. It is certified that all corrections/suggestions indicated for internal assessment have been incorporated in the report. The Project report has been approved as it satisfies the academic requirements in respect of Project Work prescribed for the said Bachelor of Engineering degree.\\
...
\begin{minipage}[t]{0.32\textwidth}
    \singlespacing
    \centering
    \textbf{Project Guide\\[0.3cm]Ms. Pallavi K V,\\Assistant Professor,\\Dept. of CSE}
\end{minipage}
\hfill
\begin{minipage}[t]{0.32\textwidth}
    \singlespacing
    \centering
    \textbf{HOD\\[0.3cm]Dr. V. Mareeswari,\\Prof. \& Head,\\Dept. of CSE}
\end{minipage}
\hfill
\begin{minipage}[t]{0.32\textwidth}
    \singlespacing
    \centering
    \textbf{Principal\\[0.3cm]Dr. Yuvaraju B N,\\Principal,\\AMCEC}
\end{minipage}

\vspace{1.0cm}
\textbf{External Viva}\\[0.2cm]
\textbf{External Name} \hspace{7cm} \textbf{Signature with Date}\\
1. \\
2. 
