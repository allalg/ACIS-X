...
Certified that the Project work entitled \textbf{``ACIS-X: INTELLIGENT COLLECTIONS SYSTEM''} carried out by bonafide students \textbf{JOHAN GEORGE} of AMC Engineering College, in partial fulfillment for the award of Bachelor of Engineering in Computer Science \& Engineering of Visvesvaraya Technological University, Belgaum during the year 2025-2026. It is certified that all corrections/suggestions indicated for internal assessment have been incorporated in the report. The Project report has been approved as it satisfies the academic requirements in respect of Project Work prescribed for the said Bachelor of Engineering degree.\\
