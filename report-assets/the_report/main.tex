...
\textit{Submitted in Partial fulfillment of the requirements for the award of the degree of \textbf{Bachelor of Engineering in Computer Science and Engineering} of Visvesvaraya Technological University, Belgaum.}
    ...
    {\textcolor[HTML]{FF0000}{\textbf{PRASANNA ACHARYA(1AM23CS149)}}}\\
    \vspace{1.0cm}
...
Certified that the project report entitled \textbf{\textcolor[HTML]{6F2C0C}{``ACIS-X: AUTOMATED CREDIT CONTROL SYSTEM''}} carried out by \textbf{NITIN BHARADWAJ M V S(1AM23CS125)}, \textbf{NIKHIL NAGENDRA(1AM23CS120)},\textbf{ JOHAN K GEORGE(1AM23CS075)}, and \textbf{PRASANNA ACHARYA(1AM23CS149)}, bonafide students of AMC Engineering College in partial fulfillment for the award of Bachelor of Engineering in Computer Science \& Engineering of the Visvesvaraya Technological University, Belgaum during the year 2025-26. It is certified that all corrections/suggestions indicated for Internal Assessment have been incorporated in the Report. The project report has been approved as it satisfies the academic requirements in respect of Project work prescribed for the said degree.\\
